<template>
  <v-container class="grey lighten-5">
    ...
    >
      ...
      <v-card-text>
        <p class="text-h6" color="orange"> Keterangan Status</p>
        <p>
  ...
  data() {
    ...
    methods: {
      async getDataRiwayat() {
        try {
          const response = await axios.get('http://192.168.34.201:8099/get_riwayat_parkir'); // Ganti '/api/endpoint' dengan URL API yang sesuai
